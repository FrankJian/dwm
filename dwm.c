/* See LICENSE file for copyright and license detailso
 *
...
enum { SchemeNorm, SchemeSel, SchemeHid, SchemeUnderline }; /* color schemes */
...
static void hideotherwinsButton(const Arg *arg);
...
drawbar(Monitor *m)
{
	int x, w, tw = 0, n = 0, scm, empty_w, tasks_w=0;
...
hideotherwins(const Arg *arg) {
    Client *c = (Client*)selmon->sel, *tc = NULL;
...
void
hideotherwinsButton(const Arg *arg) {
